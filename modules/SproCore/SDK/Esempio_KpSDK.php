...
//KpSDK::registraCampo($nome_modulo = "Nome Modulo", $blocco = "Nome Blocco", $nome_campo = "Nome Campo", $label_campo = "Label Campo", $uitype = "UI Type", $columntype = "Column Type", $typeofdata = "Type of Data", $readonly = "Readonly", $helpinfo = "Help Info", $picklist = "Valori PickingList");
KpSDK::registraCampo($nome_modulo = 'Accounts', $blocco = 'LBL_ACCOUNT_INFORMATION', $nome_campo = 'kp_test_campo', $label_campo = 'Test campo', $uitype = '1', $columntype = 'varchar(255)', $typeofdata = 'V~O', $readonly = '1', $helpinfo = '');
KpSDK::registraCampo($nome_modulo = 'Accounts', $blocco = 'LBL_ACCOUNT_INFORMATION', $nome_campo = 'kp_test_campo', $label_campo = 'Test campo', $uitype = '15', $columntype = 'varchar(255)', $typeofdata = 'V~O', $readonly = '1', $helpinfo = '', $picklist = array('a','b','c','d'));
