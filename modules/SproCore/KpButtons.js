    ...
    jQuery.ajax({
        ...
        success: function(data) {
            ...
            if (data.length > 0) {
                ...
                if (data[0].stato_ordine == 'Approved') {

                    if (data[0].tipologia_ordine == 'A progetto') {
                        ...
                        alert("Tipo ordine: " + data[0].tipologia_ordine + "! Non è possibile generare OdF per ordini di questo tipo.");
                    }
                } else {
                    alert("L'ordine deve essere in stato Approvato.");
                }
            }
        ...
        success: function(data) {
            ...
            if (data.length > 0) {
                ...
                if (data[0].stato_ordine == 'Approved') {
                    ...
                    if (data[0].tipologia_ordine == 'Abbonamento') {
                        ...
                        alert("Tipo ordine: " + data[0].tipologia_ordine + "! Non è possibile usare questa funzione per ordini di questo tipo.");
                    }
                } else {
                    alert("L'ordine deve essere in stato Approvato.");
                }
