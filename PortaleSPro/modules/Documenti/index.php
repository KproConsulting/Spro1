...
if($contact_id != 0){
	...
	if($adb->num_rows($res_account) > 0){
		...
		$kp_app_documenti = $adb->query_result($res_account, 0, 'kp_app_documenti');
		$kp_app_documenti = html_entity_decode(strip_tags($kp_app_documenti), ENT_QUOTES,$default_charset);
		if($kp_app_documenti == '1'){
			$app_documenti = true;
		}
		else{
					...
					<table class="striped" style="width: 100%;">
						<thead>	
							<tr>
								...
								<th>
									<div class="input-field col s6">
										<select id="search_stato_documento">
											<option value="all" selected></option>
											<option value="Valido senza scadenza">Valido senza scadenza</option>
											<option value="In corso di validita">In corso di validita</option>
						...
						<tbody id="body_tabella_lista_documenti">
